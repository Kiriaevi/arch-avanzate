...
if __name__ == "__main__":
    ...
    if args.t == '32':
        quantpivot = gruppo9.quantpivot32.QuantPivot()
    elif args.t == '64':
        quantpivot = gruppo9.quantpivot64.QuantPivot()
    elif args.t == '64omp':
        quantpivot = gruppo9.quantpivot64omp.QuantPivot()
